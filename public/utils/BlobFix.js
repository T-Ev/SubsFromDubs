...
var WebmUint = /** @class */ (function (_super) {
  __extends(WebmUint, _super);
  function WebmUint(name, type) {
    return _super.call(this, name, type || "Uint") || this;
  }
...
var WebmFloat = /** @class */ (function (_super) {
  __extends(WebmFloat, _super);
  function WebmFloat(name, type) {
    return _super.call(this, name, type || "Float") || this;
  }
...
var WebmContainer = /** @class */ (function (_super) {
  __extends(WebmContainer, _super);
  function WebmContainer(name, type) {
    var _this = _super.call(this, name, type || "Container") || this;
    _this.offset = 0;
    _this.data = [];
    return _this;
  }
  ...
  WebmContainer.prototype.updateByData = function () {
    ...
    var length = this.writeSections(true);
    this.source = new Uint8Array(length);
...
var WebmFile = /** @class */ (function (_super) {
  __extends(WebmFile, _super);
  function WebmFile(source) {
    var _this = _super.call(this, "File", "File") || this;
  ...
  WebmFile.prototype.toBlob = function (type) {
    if (type === void 0) {
      type = "video/webm";
    }
    return new Blob([this.source.buffer], { type: type });
  };
  return WebmFile;
})(WebmContainer);
/**
 ...
 * @returns
 */
var webmFixDuration = function (blob, duration, type) {
  if (type === void 0) {
    type = "video/webm";
  }
    ...
    try {
      ...
      reader_1.addEventListener("loadend", function () {
        try {
          ...
          var file = new WebmFile(new Uint8Array(result));
      ...
      reader_1.addEventListener("error", function () {
        return reject();
      });
      reader_1.readAsArrayBuffer(blob);
    } catch (ex) {
      reject(ex);
    }
  });
